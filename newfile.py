...
logo=f"""
 {byellow}__         __    _         __   ___  __ 
{byellow}  )_) \_)    )_)  / )  )\/)  )_)  )_   )_)
{white} / \   /    /__) (_/  (  (  /__) (__  / \    
                                            
{bgreen}               MADE BY :  RY x ZEROX 
"""
meanu=f"""{yellow}
{yellow}■ •••••••••••••••••••••••••••••••••••••••••••
 {white}◇ INDIAN NUNBER ONLY                 》  
{bpurple}◇   PRANK YOUR FRINDS                》
{green}◇   GRAY HAT HACKER                    》      
 {blue}◇  CYBER_BOY_RY                         》
 {yellow}       ■•••••••••••••••••••••••••••••••••••••••••••                      
{white }             1 :  SMS BONBING  
{bpurple}            2  : ABOUT 
...
def about():
    ...
    print(logo)
    print(f"""
{bcyan}[-]This tool is Created By Cyber_D_Zerox 
{bpurple}___________________________
{yellow}Author    :  ZEROX x RY.                         
Telegram  :  https://t.me/cyber_Boy_ry                
Version   :  1.0.                                                     
...
{red}[{byellow}1{red}]{white}-{red}>{bcyan}ZX  : Instagram
...
""")
    ...
    try:
        if option=="1":
            os.system("xdg-open https://www.instagram.com/cyber_d_zerox/ > /dev/null 2>&1 &")
        elif option=="2":
